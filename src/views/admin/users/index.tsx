            ...
            <div className="col-md-9">
                <div className="card border-0 rounded-2 shadow-sm">
                    <div className="card-header d-flex justify-content-between align-items-center">
                        <span>USERS</span>
                        <Link to="/admin/users/create" className="btn btn-sm btn-success rounded-4 shadow-sm border-0">ADD</Link>
                    </div>
                                    ...
                                    users?.map((user: User) => (
                                        <tr key={user.id}>
                                            ...
                                            <td className="text-center">
                                                <Link to={`/admin/users/edit${user.id}`} className="btn btn-sm btn-primary me-2 rounded-4 shadow-sm border-0">EDIT</Link>
